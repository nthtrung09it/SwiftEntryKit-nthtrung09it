...
public final class L5AlertMessageView: L5SimpleMessageView, EntryAppearanceDescriptor {
    // MARK: Props
    ...
    func layoutContent(with message: EKAlertMessage) {
        ...
        case .top:
            messageContentView.verticalMargins = 24
            messageContentView.horizontalMargins = 16
            messageContentView.labelsOffset = 16
